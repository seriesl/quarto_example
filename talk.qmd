...
{{< include python_sections/anim_hat2.qmd >}}
...
:::{.text-center}
![](figures/Bsvortex_osmp3_InitialState_MRAMLF_eps1e-03.png){width=45%}

![](figures/Bsvortex_osmp3_Tf10_MRAMLF_eps1e-03.png){width=45%}
:::
