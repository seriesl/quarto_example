...
def show_sol(level_min, level_max, eps, mlf=False):
    ...
    if mlf:
        filename = './data/order01/burgers_mlf_eps_'+eps+'/burgers_level_'+str(level_min)+'_'+str(level_max)+'.h5'
    else:
        filename = './data/order01/burgers_eps_'+eps+'/burgers_level_'+str(level_min)+'_'+str(level_max)+'.h5'
        
    x, u, level = read_frame(filename, 'u')

    filename = './data/order01/burgers_uniform/burgers_level_'+str(level_max)+'_'+str(level_max)+'.h5'
...
#import os.path
#print(os.path.exists('./data/order01/burgers_eps_1e-3/burgers_level_3_10.h5'))
show_sol(3, 10, '1e-3', mlf=False)
```